...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2025 at 03:09 AM
...
(19, NULL, 30, 110, NULL, 13.00),
(20, NULL, 34, 39, NULL, 21.00);
...
--
ALTER TABLE `inventorydetails`
  MODIFY `InventoryDetailsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `inventorysummary`
--
ALTER TABLE `inventorysummary`
  MODIFY `InventorySummaryID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `supplier_inventory`
  MODIFY `SupplierInventoryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
